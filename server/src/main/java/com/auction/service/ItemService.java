...
public class ItemService {
    ...
    public void deleteItem(String itemId, String requesterId) {
        ...
        // Kiểm tra nhanh bằng existsByItemId trước (không cần DB connection phức tạp).
        // Nếu sản phẩm đang/đã được dùng trong phiên, load chi tiết để kiểm tra thêm.
        if (auctionDAO.existsByItemId(itemId)) {
            ...
            if (auctions.isEmpty()) {
                // existsByItemId=true nhưng findByItemId rỗng: auction đã bị xóa mềm
